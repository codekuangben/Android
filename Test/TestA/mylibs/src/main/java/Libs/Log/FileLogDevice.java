...
//        {
//            file = string.Format("{0}/{1}_{2}{3}", path, mFilePrefix, UtilAndroidWrap.getUTCFormatText(), ".txt");
//        }
//        else
//        {
//            file = string.Format("{0}/{1}_{2}{3}{4}{5}", path, mFilePrefix, mFileSuffix, "_", UtilAndroidWrap.getUTCFormatText(), ".txt");
//        }
//
