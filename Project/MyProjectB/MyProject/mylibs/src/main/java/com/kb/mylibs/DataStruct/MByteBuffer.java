...
import com.kb.mylibs.EventHandle.*;
import com.kb.mylibs.Tools.*;
...
public class MByteBuffer implements IDispatchObject
{
    ...
    public MByteBuffer readUnsignedInt8(byte tmpByte)
    {
    ...
    public MByteBuffer readInt16(short tmpShort)
    {
    ...
    public MByteBuffer readUnsignedInt16(short tmpUshort)
    {
        if (canRead(Short.SIZE))
        {
    ...
    public MByteBuffer readInt32(int tmpInt)
    {
    ...
    public MByteBuffer readUnsignedInt32(int tmpUint)
    {
        if (canRead(Integer.SIZE))
        {
            // 如果字节序和本地字节序不同，需要转换
    ...
    public MByteBuffer readInt64(long tmpLong)
    {
    ...
    public MByteBuffer readUnsignedInt64(long tmpUlong)
    {
        if (canRead(Long.SIZE))
        {
    ...
    public MByteBuffer readFloat(float tmpFloat)
    {
    ...
    public MByteBuffer readDouble(double tmpDouble)
    {
